...
#  Ferramentas
### 📊 Dataset
- World Happiness Report (2005–2025):  Apresenta dados dos países com maior taxa de felicidade
- Undernourishment dataset (2000–2024): Apresenta dados de países com a maior taxa de desnutrição.
...
## 📈 Conclusões
- Existe sim uma relação entre a taxa de desnutrição e a taxa de felicidade de um país, porém a desnutrição não é o único fator que interfere na felicidade de um país. Nos gráficos apresentados podemos ver que a maior parte dos países com a taxa de felicidade alta são países com baixa taxa de desnutrição, porém há excessões.
